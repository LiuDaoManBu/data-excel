...
public enum NaturalDataType implements DataType {
  ...
  WHOLE_NUMBER(() -> {
    ...
    Collections.addAll(classes, byte.class, Byte.class, short.class, Short.class, int.class,
  ...
  NATURAL_NUMBER(POSITIVE_WHOLE_NUMBER.canCastClasses()) {
    ...
    public boolean matches(Object value) {
      try {
        return POSITIVE_WHOLE_NUMBER.matches(value)
  ...
  @Override
  public <T> T cast(Object value, Class<T> clazz) {
    if (Sets.newHashSet(byte.class, Byte.class, short.class, Short.class, int.class, Integer.class,
        long.class, Long.class, BigInteger.class).contains(clazz)) {
