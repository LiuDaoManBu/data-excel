...
import com.caotc.util.excel.matcher.data.type.NaturalDataType;
...
public class ComparableValueMatcher<T extends Comparable<T>> extends DataValueMatcher {
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((matcherValue == null) ? 0 : matcherValue.hashCode());
		result = prime
				* result
				+ ((valueMatcherType == null) ? 0 : valueMatcherType.hashCode());
		return result;
	}
	...
	public boolean matches(Object value) {
		...
		return valueMatcherType.matches(matcherValue, (T) NaturalDataType.NUMBER.cast(value, matcherValue
				.getClass()));
	}
