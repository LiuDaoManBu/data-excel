...
import com.caotc.util.excel.matcher.data.value.ComparableValueMatcher.ComparableValueMatcherType;

public class StringLengthMatcher extends StringMatcher {
	private static final ComparableValueMatcherType DEFAULT_COMPARABLE_VALUE_MATCHER_TYPE=ComparableValueMatcherType
			.MAX_OR_EQUALS;
	...
	public int hashCode() {
		...
		int result = 1;
		result = prime * result
				+ ((valueMatcher == null) ? 0 : valueMatcher.hashCode());
		return result;
	}
